...
public class ReadmeSamples {
    ...
    public static void main(String[] args){
        ReadmeSamples readmeSamples = new ReadmeSamples();
        /*readmeSamples.consumeEventsFromPartition();
        readmeSamples.consumeEventsFromPartitionUsingSyncClient();
        try {
            readmeSamples.consumeEventsUsingEventProcessor();
    ...
    public void consumeEventsFromPartition() {
        EventHubConsumerAsyncClient consumer = new EventHubClientBuilder()
            .connectionString("Endpoint=sb://c3m-event-hub.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=ESukQ9Gf6t1TznT0QZ5wkkCVfC1lQEa8mlE/TnwFmnc=","C3M-Event-Hub")
